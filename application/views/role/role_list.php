                ...
                <form class="form-horizontal" id="form-simpan">
                    ...
                    <div class="row clearfix padding-form">
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                            <label for="email_address_2">ID Role</label>
                        </div>
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="role_id" name="role_id" class="form-control" placeholder="Masukkan id role">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix padding-form">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="level" name="level" class="form-control" placeholder="Masukkan level dari role">
                                </div>
                            </div>
                        </div>
                    </div>
...
//        });
    ...
    function setModalHapus(dom) {
        ...
        $(".fa-spinner").hide();
        $("#btn-hapus").show();
        $("#modal-hapus .modal-body").html("Anda yakin menghapus Role dengan nama "+text+"?");
        $("#id-delete").val(id);
    }
    function hapus() {
        ...
        console.log(id);
        $.ajax({
            url: "<?php echo site_url('role/hapus'); ?>",
            data: {'id': id},
            dataType: 'JSON',
            beforeSend: function () {
                $(".fa-spinner").show();
        ...
        if ($("form#form-simpan").validate().form() === true) 
	{
            ...
            var id = $("#kode").val();
            $.ajax({
                    url: "<?php echo site_url("role/simpan"); ?>/" + id,
                    data: data,
                    type: "POST",
                    dataType: 'JSON',
                    beforeSend: function () {
